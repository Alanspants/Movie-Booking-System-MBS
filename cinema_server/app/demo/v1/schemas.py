...
filters = {
    ('cinema', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'id': {'type': 'integer'}, 'name': {'type': 'string'}, 'address': {'type': 'string'}, 'phone': {'type': 'string'}}}}}, 404: {'headers': None, 'schema': None}},
    ('cinema_available', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'id': {'type': 'integer'}, 'name': {'type': 'string'}, 'address': {'type': 'string'}, 'phone': {'type': 'string'}}}}}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ...
    ('movie_id_cinema', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'id': {'type': 'integer'}, 'name': {'type': 'string'}}}}}},
    ('movie_search', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'id': {'type': 'integer'}, 'title': {'type': 'string'}}}}}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}
