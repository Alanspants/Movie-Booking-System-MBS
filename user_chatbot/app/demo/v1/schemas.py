...
filters = {
    ('user_register', 'POST'): {201: {'headers': None, 'schema': {'type': 'object', 'properties': {'username': {'type': 'string'}, 'password': {'type': 'string'}, 'userID': {'type': 'integer'}}}}, 403: {'headers': None, 'schema': None}},
    ('user_login', 'POST'): {201: {'headers': None, 'schema': {'type': 'object', 'properties': {'username': {'type': 'string'}, 'password': {'type': 'string'}, 'userID': {'type': 'integer'}}}}, 404: {'headers': None, 'schema': None}},
    ('chatbot_ask', 'GET'): {200: {'headers': None, 'schema': {'type': 'string'}}},
}
