...
filters = {
    ('all', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'movie_title': {'type': 'string'}, 'movie_id': {'type': 'integer'}, 'timetable': {'type': 'array', 'items': {'type': 'object', 'properties': {'timeslots_id': {'type': 'integer'}, 'cinema_id': {'type': 'integer'}, 'cinema_name': {'type': 'string'}, 'date': {'type': 'string'}, 'start_time': {'type': 'string'}, 'seats': {'type': 'string'}}}}}}}}, 404: {'headers': None, 'schema': None}},
    ('movie_movie_id', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'movie_title': {'type': 'string'}, 'movie_id': {'type': 'integer'}, 'timetable': {'type': 'array', 'items': {'type': 'object', 'properties': {'timeslots_id': {'type': 'integer'}, 'cinema_id': {'type': 'integer'}, 'cinema_name': {'type': 'string'}, 'date': {'type': 'string'}, 'start_time': {'type': 'string'}, 'seats': {'type': 'string'}}}}}}}}, 404: {'headers': None, 'schema': None}},
    ('cinema_cinema_id', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'type': 'object', 'properties': {'movie_title': {'type': 'string'}, 'movie_id': {'type': 'integer'}, 'timetable': {'type': 'array', 'items': {'type': 'object', 'properties': {'timeslots_id': {'type': 'integer'}, 'cinema_id': {'type': 'integer'}, 'cinema_name': {'type': 'string'}, 'date': {'type': 'string'}, 'start_time': {'type': 'string'}, 'seats': {'type': 'string'}}}}}}}}, 404: {'headers': None, 'schema': None}},
    ('available', 'GET'): {200: {'headers': None, 'schema': {'type': 'boolean'}}, 404: {'headers': None, 'schema': None}},
    ('booking', 'POST'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'movie_title': {'type': 'string'}, 'cinema_name': {'type': 'string'}, 'booking_date': {'type': 'string'}, 'booking_start_time': {'type': 'string'}, 'seat_number': {'type': 'integer'}}}}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('booking', 'DELETE'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'movie_title': {'type': 'string'}, 'cinema_name': {'type': 'string'}, 'booking_date': {'type': 'string'}, 'booking_start_time': {'type': 'string'}, 'seat_number': {'type': 'integer'}}}}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}
